      ...
      <div className={styles.bodyInner}>
        <div className={styles.font}>
          ...
          <img
            ...
            alt=""
            src="../public/images/unsplash_rarn_gq1SBA.png"
          />
          <img
            className={styles.unsplashrarnGq1sbaIcon1}
            alt=""
            src="../public/images/unsplash_rarn_gq1SBA.png"
          />
          <img
            className={styles.unsplashrarnGq1sbaIcon2}
            alt=""
            src="../public/images/unsplash_rarn_gq1SBA.png"
          />
          <img
            className={styles.unsplashDank9gjvdyIcon}
            alt=""
            src="../public/images/unsplash__dAnK9GJvdY.svg"
          />
          <img
            className={styles.unsplashDank9gjvdyIcon1}
            alt=""
            src="../public/images/unsplash__dAnK9GJvdY.svg"
          />
          <img
            className={styles.unsplashDank9gjvdyIcon2}
            alt=""
            src="../public/images/unsplash__dAnK9GJvdY.svg"
          />
        </div>
